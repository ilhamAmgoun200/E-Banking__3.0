...
public class AuthService {
    ...
    public String registerUser(String username, String password, String email, String firstName, String lastName, String roleName, String cin) {
        ...
        if (response.getStatus() == 201) {
            ...
            try {
                ...
                userServiceClient.createUserProfile(userDTO,internalSecret);
